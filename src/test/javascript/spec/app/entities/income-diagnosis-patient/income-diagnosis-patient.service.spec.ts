...
describe('Service Tests', () => {
  describe('IncomeDiagnosisPatient Service', () => {
    ...
    let expectedResult: IIncomeDiagnosisPatient | IIncomeDiagnosisPatient[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new IncomeDiagnosisPatient(0, 'AAAAAAA', 0, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a IncomeDiagnosisPatient', () => {
        ...
        service
          .create(new IncomeDiagnosisPatient())
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a IncomeDiagnosisPatient', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            incomeDiagnosisId: 1,
      ...
      it('should return a list of IncomeDiagnosisPatient', () => {
        const returnedFromService = Object.assign(
          {
            description: 'BBBBBB',
            incomeDiagnosisId: 1,
      ...
      it('should delete a IncomeDiagnosisPatient', () => {
