...
/**
 * Integration tests for the {@link InitialAssessmentResource} REST controller.
 */
@SpringBootTest(classes = CardioRehabCrApp.class)
public class InitialAssessmentResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static InitialAssessment createUpdatedEntity(EntityManager em) {
        InitialAssessment initialAssessment = new InitialAssessment()
