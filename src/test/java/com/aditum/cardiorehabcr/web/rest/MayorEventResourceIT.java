...
/**
 * Integration tests for the {@link MayorEventResource} REST controller.
 */
@SpringBootTest(classes = CardioRehabCrApp.class)
public class MayorEventResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static MayorEvent createUpdatedEntity(EntityManager em) {
        MayorEvent mayorEvent = new MayorEvent()
