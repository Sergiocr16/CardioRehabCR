...
/**
 * Integration tests for the {@link ComorbiditieResource} REST controller.
 */
@SpringBootTest(classes = CardioRehabCrApp.class)
public class ComorbiditieResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Comorbiditie createUpdatedEntity(EntityManager em) {
        Comorbiditie comorbiditie = new Comorbiditie()
