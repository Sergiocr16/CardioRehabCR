...
/**
 * Integration tests for the {@link IncomeDiagnosisResource} REST controller.
 */
@SpringBootTest(classes = CardioRehabCrApp.class)
public class IncomeDiagnosisResourceIT {
    ...
    @Autowired
    private IncomeDiagnosisServiceImpl incomeDiagnosisService;
     ...
     * if they test an entity which requires the current entity.
     */
    public static IncomeDiagnosis createUpdatedEntity(EntityManager em) {
        IncomeDiagnosis incomeDiagnosis = new IncomeDiagnosis()
