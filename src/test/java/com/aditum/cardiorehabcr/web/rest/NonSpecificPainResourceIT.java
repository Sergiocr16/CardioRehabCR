...
/**
 * Integration tests for the {@link NonSpecificPainResource} REST controller.
 */
@SpringBootTest(classes = CardioRehabCrApp.class)
public class NonSpecificPainResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static NonSpecificPain createUpdatedEntity(EntityManager em) {
        NonSpecificPain nonSpecificPain = new NonSpecificPain()
