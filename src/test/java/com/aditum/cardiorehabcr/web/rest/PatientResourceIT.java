...
public class PatientResourceIT {
    ...
    public void getAllPatients() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ocupation").value(hasItem(DEFAULT_OCUPATION)))
            .andExpect(jsonPath("$.[*].lastEventOcurred").value(hasItem(DEFAULT_LAST_EVENT_OCURRED.toString())))
    ...
    public void getPatient() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients/{id}", patient.getId()))
            ...
            .andExpect(jsonPath("$.ocupation").value(DEFAULT_OCUPATION))
            .andExpect(jsonPath("$.lastEventOcurred").value(DEFAULT_LAST_EVENT_OCURRED.toString()))
